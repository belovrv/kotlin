...
public class ResolveElementCache(
    ...
    private fun initializerAdditionalResolve(resolveSession: ResolveSession, classInitializer: KtClassInitializer, file: KtFile, statementFilter: StatementFilter): BindingTrace {
        ...
        val classObjectOrScript: KtDeclaration = classInitializer.getParentOfType<KtClassOrObject>(true) ?: classInitializer.getParentOfType<KtScript>(true)!!
        val classOrObjectDescriptor = resolveSession.resolveToDescriptor(classObjectOrScript) as LazyClassDescriptor
