...
class ModuleVisibilityHelperImpl : ModuleVisibilityHelper {
    ...
    override fun isInFriendModule(what: DeclarationDescriptor, from: DeclarationDescriptor): Boolean {
        ...
        // Hack for incremental compilation in case of circular dependent modules
        // TODO Implement check for access to internal for incremental compilation in case of circular dependency between modules
